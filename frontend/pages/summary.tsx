...
const PageTicketSummary: FC = ({ asidePanel }: any) => {
              ...
              <div className="p-form p-form--stacked">
                <div className="p-form__group row">
                  <div className="col-1 u-align--center">
                    <label className="p-form__label">From</label>
                  </div>
                  <div className="col-3">
                  ...
                  <div className="col-1 u-align--center">
                    <label className="p-form__label">To</label>
                  </div>
                  <div className="col-3">
                    <div className="p-form__control">
                      <DatePicker
